...
class ExposedChatOutputport : ChatOutputPort {
    ...
    override fun save(chat: Chat): Chat = transaction {
    ...
    private fun addOrUpdateChatMessage(message: Message, chatId: UUID) = transaction {
        val existingMessage = ChatMessageTable.selectAll().where {
    ...
    private fun addOrUpdateChatUser(userId: UUID, chatId: UUID) = transaction {
        val existingUser = ChatUserTable.selectAll().where {
